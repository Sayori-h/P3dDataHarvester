...
//			Init.OnGround = 0.0;
//			Init.Airspeed = 60.0;
//			Init.dWindVelocity = 900.0;
//			Init.dWindDirection = 180.0;
...
//		hr = SimConnect_AddToDataDefinition(hSimConnect, DEFINITION_INIT, "INITIAL POSITION", NULL, SIMCONNECT_DATATYPE_FLOAT64);
//
...
//		hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_INIT, "My.X");
//		hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_STRUCT, "My.B");
//
//		// Link the custom event to some keyboard keys, and turn the input event off
//		hr = SimConnect_MapInputEventToClientEvent(hSimConnect, INPUT_INIT, "X", EVENT_INIT);
//		hr = SimConnect_SetInputGroupState(hSimConnect, INPUT_INIT, SIMCONNECT_STATE_OFF);
//		hr = SimConnect_MapInputEventToClientEvent(hSimConnect, INPUT_STRUCT, "B", EVENT_STRUCT);
